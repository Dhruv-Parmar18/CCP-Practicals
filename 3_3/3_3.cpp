...
public:
    ...
    {                 // passing reference variable to change both objects data
...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            {
                if (c.returnAccNum() == MyAccNum)
                { // searching for sender account
                    chk++;
                    for (AccountManager &a : A)
                    {
                        if (a.returnAccNum() == AccNum)
                        { // searching for receiver account
                            chk++;
                            c.Transfer(a, Bal);
                            break;
                        }
            ...
            cout << endl
                 << Bal << " Rupees transferred succesfully!!";
            break;
        ...
        case 3:
            ...
            i = 1;
            for (AccountManager &a : A)
            { // for loop for vectors using reference variable
                cout << "\n\nAccount " << i;
                a.DisplayDetails();
                i++;
            }
