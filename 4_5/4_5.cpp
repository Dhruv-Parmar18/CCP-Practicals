...
class UgGrading : private Grading
{
    ...
    { // each out of 50, total 3 sub, each sub pass or fail
        Percent = (m1 + m2 + m3) / 1.5;
        Grade1 = m1 > 45 ? 'O' : m1 > 40 ? 'I'
                             : m1 > 35   ? 'A'
                             : m1 > 30   ? 'B'
                             : m1 > 25   ? 'C'
                             : m1 > 17   ? 'D'
                                         : 'F';
        Grade2 = m2 > 45 ? 'O' : m2 > 40 ? 'I'
                             : m2 > 35   ? 'A'
                             : m2 > 30   ? 'B'
                             : m2 > 25   ? 'C'
                             : m2 > 17   ? 'D'
                                         : 'F'; // different grading system
        Grade3 = m3 > 45 ? 'O' : m3 > 40 ? 'I'
                             : m3 > 35   ? 'A'
                             : m3 > 30   ? 'B'
                             : m3 > 25   ? 'C'
                             : m3 > 17   ? 'D'
...
{
    void CalculateGrade() override
    { // each out of 100, total 2 sub, average pass or fail
        Percent = (m1 + m2) / 2;
        Grade = Percent > 95 ? 'O' : Percent > 90 ? 'A'
                                 : Percent > 80   ? 'B'
                                 : Percent > 70   ? 'C'
                                 : Percent > 60   ? 'D'
                                 : Percent > 50   ? 'E'
